...
var (
	geminiOAuthClientID     = os.Getenv("CPA_GEMINI_CLIENT_ID")
	geminiOAuthClientSecret = os.Getenv("CPA_GEMINI_CLIENT_SECRET")
)
...
var (
	antigravityOAuthClientID     = os.Getenv("CPA_ANTIGRAVITY_CLIENT_ID")
	antigravityOAuthClientSecret = os.Getenv("CPA_ANTIGRAVITY_CLIENT_SECRET")
)
